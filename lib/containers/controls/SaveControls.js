...
var SaveControls = function (_Component) {
  ...
  function SaveControls() {
    ...
    _this.afterClick = function (state, currentHref, fetchDone) {
    ...
    _this.getNewPageStates = function (page) {
      if (!page) {
        return null;
      }
    ...
    _this.getNextState = function () {
      ...
      if (state === null || state === undefined) {
        var newPage = _this.getNewPage();
        state = _this.getNewPageStates(newPage);
      }
    ...
    _this.clickAll2 = function () {
      ...
      if (state && state.onclick) {
        ...
        try {
          state.click();
          var timeout = setTimeout(_this.afterClick.bind(_this, state, currentHref), 200);
        } catch (e) {
          alert(e);
        }
      } else {
    ...
    _this.checkNewPage = function (currHref, newHref, state) {
      ...
      var newState = grailActions.isNewState().newPageState;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { className: (0, _aphrodite.css)(styles.grailTestButton, styles.grailTestCheck), onClick: function onClick() {
            return _this3.clickAll2(_this3.getDocument(), true);
          } },
        'click all'
      ),
      _react2.default.createElement(
